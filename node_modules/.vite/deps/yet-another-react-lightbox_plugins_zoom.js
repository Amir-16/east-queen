  ...
  augment(({ zoom: zoomProps, toolbar, render, controller, ...restProps }) => {
    ...
    return {
      ...
      render: {
        ...
        slide: (props) => {
          var _a, _b;
          return isImageSlide(props.slide) || props.slide.type != null && ((_a = zoom.supports) === null || _a === void 0 ? void 0 : _a.includes(props.slide.type)) ? React.createElement(ZoomWrapper, { render, ...props }) : (_b = render.slide) === null || _b === void 0 ? void 0 : _b.call(render, props);
        }
      },
