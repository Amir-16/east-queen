  ...
  return (
    <section ref={ref} className="section-padding bg-white relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 60% 70% at 85% 40%, rgba(226,31,47,0.04) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="section-container">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            {/* Corner accent — bottom right (offset from photo) */}
            <div className="absolute -bottom-5 right-[calc(100%-380px+20px)] lg:right-[-1.25rem] w-20 h-20 border-b-2 border-r-2 border-gold-500/40 rounded-br-xl pointer-events-none" />
          ...
          >
            ...
            <blockquote className="font-playfair text-2xl lg:text-[1.65rem] text-navy-900 leading-[1.45] mb-8 italic">
              <ClipRevealText text={CHAIRMAN.quote} inView={inView} />
            </blockquote>
            ...
            <motion.div
              ...
              className="mb-5"
            >
              <p className="font-inter font-bold text-navy-900 text-base">{CHAIRMAN.name}</p>
