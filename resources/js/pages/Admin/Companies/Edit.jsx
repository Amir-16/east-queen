...
export default function CompaniesEdit() {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        long_description: Array.isArray(company.long_description) ? company.long_description : [],
        services:         Array.isArray(company.services)         ? company.services         : [],
        export_items:     Array.isArray(company.export_items)     ? company.export_items     : [],
        import_items:     Array.isArray(company.import_items)     ? company.import_items     : [],
        logo:             company.logo             ?? '',
        cover_image:      company.cover_image      ?? '',
        gallery_images:   Array.isArray(company.gallery_images)   ? company.gallery_images   : [],
