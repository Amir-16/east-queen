...
function MosaicImg({ src, alt, span, delay }) {
  ...
  return (
    ...
    >
      <div className={`absolute inset-0 bg-navy-800 animate-pulse transition-opacity duration-500 ${loaded ? 'opacity-0 pointer-events-none' : 'opacity-100'}`} />
      <img
        src={src}
        alt={alt}
        loading="lazy"
        ...
        className={`w-full h-full object-cover object-center group-hover:scale-105 transition-all duration-700 ease-out ${loaded ? 'opacity-100' : 'opacity-0'}`}
      />
        ...
        <div className="flex flex-col justify-center px-5 sm:px-8 lg:px-10 py-10 sm:py-16 lg:py-20 relative">
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <span className="text-gold-500 text-[11px] font-semibold uppercase tracking-[0.28em]">Our Story</span>
            </motion.div>
