...
export default function StatsSection({ stats = [] }) {
  ...
  return (
    <section className="relative overflow-hidden py-28">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-transparent via-gold-500/30 to-transparent" />
          ...
          {stats.map((stat, i) => (
            ...
            >
              <p className="font-mono font-black text-[52px] sm:text-[62px] leading-none text-white mb-2">
                {inView ? (
                  <CountUp end={stat.value} duration={2.5} delay={0.3 + i * 0.1} separator="," />
                ) : '0'}
