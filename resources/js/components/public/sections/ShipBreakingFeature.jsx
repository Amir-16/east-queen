        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              <Link
                href="/ship-breaking"
                className="group inline-flex items-center gap-2.5 bg-gold-500 hover:bg-gold-400 text-white font-bold text-sm px-7 py-3.5 rounded-lg tracking-wide transition-all duration-200 hover:shadow-gold-glow"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2.5 glass-dark hover:bg-white/[0.1] text-white/65 hover:text-white font-semibold px-7 py-3.5 rounded-lg text-sm transition-all duration-200"
              >
                About the Company
              </Link>
            </motion.div>
          ...
          {/* Right — stat cards (stacked vertical) */}
          <motion.div
            variants={stagger}
            initial="hidden"
          ...
          >
            {highlights.map(({ icon: Icon, stat, unit, detail }) => (
              <motion.div
                key={detail}
                variants={fadeUp}
                className="flex items-center gap-5 glass-dark rounded-2xl px-6 py-5 hover:bg-white/[0.1] transition-colors duration-200 cursor-default"
              >
                <div className="w-12 h-12 rounded-xl bg-gold-500/12 border border-gold-500/20 flex items-center justify-center shrink-0">
